...
This document is the single source of truth on contributing towards this codebase. Feel free to browse the [open issues](https://github.com/khulnasoft/docker-khulnasoft/issues) and file new ones - all feedback is welcome!
...
* Khulnasoft employees
* Individuals who have signed the [Khulnasoft Contributor License Agreement](https://www.khulnasoft.com/en_us/form/contributions.html)
...
Have ideas on improvements? See something that needs work? While the community encourages everyone to contribute code, it is also appreciated when someone reports an issue. Please report any issues or bugs you find through our [issue tracker](https://github.com/khulnasoft/docker-khulnasoft/issues).
...
#### Fixing issues
Look through our [issue tracker](https://github.com/khulnasoft/docker-khulnasoft/issues) to find problems to fix! Feel free to comment and tag corresponding stakeholders or full-time maintainers of this project with any questions or concerns.
