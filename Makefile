...
DOCKER_BUILD_FLAGS ?=
KHULNASOFT_ANSIBLE_REPO ?= https://github.com/khulnasoft/khulnasoft-ansible.git
KHULNASOFT_ANSIBLE_BRANCH ?= develop
KHULNASOFT_COMPOSE ?= cluster_absolute_unit.yaml
# Set Khulnasoft version/build parameters here to define downstream URLs and file names
KHULNASOFT_PRODUCT := khulnasoft
KHULNASOFT_VERSION := 9.2.1
KHULNASOFT_BUILD := 78803f08aabb
ifeq ($(shell arch), s390x)
	KHULNASOFT_ARCH = s390x
else
	KHULNASOFT_ARCH = x86_64
endif

# Linux Khulnasoft arguments
KHULNASOFT_LINUX_FILENAME ?= khulnasoft-${KHULNASOFT_VERSION}-${KHULNASOFT_BUILD}-Linux-${KHULNASOFT_ARCH}.tgz
KHULNASOFT_LINUX_BUILD_URL ?= https://download.khulnasoft.com/products/${KHULNASOFT_PRODUCT}/releases/${KHULNASOFT_VERSION}/linux/${KHULNASOFT_LINUX_FILENAME}
UF_LINUX_FILENAME ?= khulnasoftforwarder-${KHULNASOFT_VERSION}-${KHULNASOFT_BUILD}-Linux-${KHULNASOFT_ARCH}.tgz
UF_LINUX_BUILD_URL ?= https://download.khulnasoft.com/products/universalforwarder/releases/${KHULNASOFT_VERSION}/linux/${UF_LINUX_FILENAME}
# Windows Khulnasoft arguments
KHULNASOFT_WIN_FILENAME ?= khulnasoft-${KHULNASOFT_VERSION}-${KHULNASOFT_BUILD}-x64-release.msi
KHULNASOFT_WIN_BUILD_URL ?= https://download.khulnasoft.com/products/${KHULNASOFT_PRODUCT}/releases/${KHULNASOFT_VERSION}/windows/${KHULNASOFT_WIN_FILENAME}
UF_WIN_FILENAME ?= khulnasoftforwarder-${KHULNASOFT_VERSION}-${KHULNASOFT_BUILD}-x64-release.msi
UF_WIN_BUILD_URL ?= https://download.khulnasoft.com/products/universalforwarder/releases/${KHULNASOFT_VERSION}/windows/${UF_WIN_FILENAME}
...
SCANNER_IMAGES_TO_SCAN := khulnasoft-debian-9 khulnasoft-debian-10 khulnasoft-centos-7 khulnasoft-redhat-8 uf-debian-9 uf-debian-10 uf-centos-7 uf-redhat-8 khulnasoft-py23-debian-9 khulnasoft-py23-debian-10 khulnasoft-py23-centos-7 khulnasoft-py23-redhat-8 uf-py23-debian-9 uf-py23-debian-10 uf-py23-centos-7 uf-py23-redhat-8
CONTAINERS_TO_SAVE := khulnasoft-debian-9 khulnasoft-debian-10 khulnasoft-centos-7 khulnasoft-redhat-8 uf-debian-9 uf-debian-10 uf-centos-7 uf-redhat-8 khulnasoft-py23-debian-9 khulnasoft-py23-debian-10 khulnasoft-py23-centos-7 khulnasoft-py23-redhat-8 uf-py23-debian-9 uf-py23-debian-10 uf-py23-centos-7 uf-py23-redhat-8
...
all: khulnasoft uf khulnasoft-py23 uf-py23

ansible:
	@if [ -d "khulnasoft-ansible" ]; then \
		echo "Ansible directory exists - skipping clone"; \
	else \
		git clone ${KHULNASOFT_ANSIBLE_REPO} --branch ${KHULNASOFT_ANSIBLE_BRANCH}; \
	fi
	@cd khulnasoft-ansible && git rev-parse HEAD > version.txt
	@cat khulnasoft-ansible/version.txt
...
base-redhat-8:
	docker build ${DOCKER_BUILD_FLAGS} --label version=${KHULNASOFT_VERSION} -t base-redhat-8:${IMAGE_VERSION} ./base/redhat-8

base-redhat-8-armv8:
	docker buildx build ${DOCKER_BUILD_FLAGS} --build-arg BUSYBOX_URL=${BUSYBOX_URL} --label version=${KHULNASOFT_VERSION} -t base-redhat-8-armv8:${IMAGE_VERSION} ./base/redhat-8
...
minimal-debian-9: base-debian-9
	docker build ${DOCKER_BUILD_FLAGS} \
		-f khulnasoft/common-files/Dockerfile \
		--build-arg KHULNASOFT_BASE_IMAGE=base-debian-9 \
		--build-arg KHULNASOFT_BUILD_URL=${KHULNASOFT_LINUX_BUILD_URL} \
		--target minimal -t minimal-debian-9:${IMAGE_VERSION} .	

minimal-debian-10: base-debian-10
	docker build ${DOCKER_BUILD_FLAGS} \
		-f khulnasoft/common-files/Dockerfile \
		--build-arg KHULNASOFT_BASE_IMAGE=base-debian-10 \
		--build-arg KHULNASOFT_BUILD_URL=${KHULNASOFT_LINUX_BUILD_URL} \
...
minimal-centos-7: base-centos-7
	docker build ${DOCKER_BUILD_FLAGS} \
		-f khulnasoft/common-files/Dockerfile \
		--build-arg KHULNASOFT_BASE_IMAGE=base-centos-7 \
		--build-arg KHULNASOFT_BUILD_URL=${KHULNASOFT_LINUX_BUILD_URL} \
...
minimal-centos-8: base-centos-8
	docker build ${DOCKER_BUILD_FLAGS} \
		-f khulnasoft/common-files/Dockerfile \
		--build-arg KHULNASOFT_BASE_IMAGE=base-centos-8 \
		--build-arg KHULNASOFT_BUILD_URL=${KHULNASOFT_LINUX_BUILD_URL} \
...
minimal-redhat-8: base-redhat-8
	docker build ${DOCKER_BUILD_FLAGS} \
		-f khulnasoft/common-files/Dockerfile \
		--build-arg KHULNASOFT_BASE_IMAGE=base-redhat-8 \
		--build-arg KHULNASOFT_BUILD_URL=${KHULNASOFT_LINUX_BUILD_URL} \
...
##### Khulnasoft images #####
khulnasoft: ansible khulnasoft-debian-9 khulnasoft-debian-10 khulnasoft-centos-7 khulnasoft-centos-8 khulnasoft-redhat-8

khulnasoft-debian-9: base-debian-9 ansible
	docker build ${DOCKER_BUILD_FLAGS} \
		-f khulnasoft/common-files/Dockerfile \
		--build-arg KHULNASOFT_BASE_IMAGE=base-debian-9 \
		--build-arg KHULNASOFT_BUILD_URL=${KHULNASOFT_LINUX_BUILD_URL} \
		-t khulnasoft-debian-9:${IMAGE_VERSION} .

khulnasoft-debian-10: base-debian-10 ansible
	docker build ${DOCKER_BUILD_FLAGS} \
		-f khulnasoft/common-files/Dockerfile \
		--build-arg KHULNASOFT_BASE_IMAGE=base-debian-10 \
		--build-arg KHULNASOFT_BUILD_URL=${KHULNASOFT_LINUX_BUILD_URL} \
		-t khulnasoft-debian-10:${IMAGE_VERSION} .

khulnasoft-centos-7: base-centos-7 ansible
	docker build ${DOCKER_BUILD_FLAGS} \
		-f khulnasoft/common-files/Dockerfile \
		--build-arg KHULNASOFT_BASE_IMAGE=base-centos-7 \
		--build-arg KHULNASOFT_BUILD_URL=${KHULNASOFT_LINUX_BUILD_URL} \
		-t khulnasoft-centos-7:${IMAGE_VERSION} .

khulnasoft-centos-8: base-centos-8 ansible 
	docker build ${DOCKER_BUILD_FLAGS} \
		-f khulnasoft/common-files/Dockerfile \
		--build-arg KHULNASOFT_BASE_IMAGE=base-centos-8 \
		--build-arg KHULNASOFT_BUILD_URL=${KHULNASOFT_LINUX_BUILD_URL} \
		-t khulnasoft-centos-8:${IMAGE_VERSION} .

khulnasoft-redhat-8: base-redhat-8 ansible
	docker build ${DOCKER_BUILD_FLAGS} \
		-f khulnasoft/common-files/Dockerfile \
		--build-arg KHULNASOFT_BASE_IMAGE=base-redhat-8 \
		--build-arg KHULNASOFT_BUILD_URL=${KHULNASOFT_LINUX_BUILD_URL} \
		-t khulnasoft-redhat-8:${IMAGE_VERSION} .

khulnasoft-windows-2016: base-windows-2016 ansible
	docker build ${DOCKER_BUILD_FLAGS} \
		-f khulnasoft/windows-2016/Dockerfile \
		--build-arg KHULNASOFT_BASE_IMAGE=base-windows-2016 \
		--build-arg KHULNASOFT_BUILD_URL=${KHULNASOFT_WIN_BUILD_URL} \
		-t khulnasoft-windows-2016:${IMAGE_VERSION} .
...
ufbare-debian-9: base-debian-9 ansible
	docker build ${DOCKER_BUILD_FLAGS} \
		...
		--build-arg KHULNASOFT_BASE_IMAGE=base-debian-9 \
		--build-arg KHULNASOFT_BUILD_URL=${UF_LINUX_BUILD_URL} \
...
uf-redhat-8-armv8: base-redhat-8-armv8 ansible
	docker buildx build ${DOCKER_BUILD_FLAGS} \
		-f uf/common-files/Dockerfile \
		--build-arg KHULNASOFT_BASE_IMAGE=base-redhat-8-armv8 \
		--build-arg KHULNASOFT_BUILD_URL=${UF_LINUX_BUILD_URL} \
...
uf-windows-2016: base-windows-2016 ansible
	docker build ${DOCKER_BUILD_FLAGS} \
		...
		--build-arg KHULNASOFT_BASE_IMAGE=base-windows-2016 \
		--build-arg KHULNASOFT_BUILD_URL=${UF_WIN_BUILD_URL} \
		-t uf-windows-2016:${IMAGE_VERSION} .


##### Python 3 support #####
khulnasoft-py23: khulnasoft-py23-debian-9 khulnasoft-py23-debian-10 khulnasoft-py23-centos-7 khulnasoft-py23-centos-8 khulnasoft-py23-redhat-8

khulnasoft-py23-debian-9: khulnasoft-debian-9
	docker build ${DOCKER_BUILD_FLAGS} \
		-f py23-image/debian-9/Dockerfile \
		--build-arg KHULNASOFT_PRODUCT=khulnasoft \
		-t khulnasoft-py23-debian-9:${IMAGE_VERSION} .

khulnasoft-py23-debian-10: khulnasoft-debian-10
	docker build ${DOCKER_BUILD_FLAGS} \
		-f py23-image/debian-10/Dockerfile \
		--build-arg KHULNASOFT_PRODUCT=khulnasoft \
		-t khulnasoft-py23-debian-10:${IMAGE_VERSION} .

khulnasoft-py23-centos-7: khulnasoft-centos-7
	docker build ${DOCKER_BUILD_FLAGS} \
		-f py23-image/centos-7/Dockerfile \
		--build-arg KHULNASOFT_PRODUCT=khulnasoft \
		-t khulnasoft-py23-centos-7:${IMAGE_VERSION} .

khulnasoft-py23-centos-8: khulnasoft-centos-8
	docker build ${DOCKER_BUILD_FLAGS} \
		-f py23-image/centos-8/Dockerfile \
		--build-arg KHULNASOFT_PRODUCT=khulnasoft \
		-t khulnasoft-py23-centos-8:${IMAGE_VERSION} .

khulnasoft-py23-redhat-8: khulnasoft-redhat-8
	docker build ${DOCKER_BUILD_FLAGS} \
		-f py23-image/redhat-8/Dockerfile \
		--build-arg KHULNASOFT_PRODUCT=khulnasoft \
		-t khulnasoft-py23-redhat-8:${IMAGE_VERSION} .
...
uf-py23-debian-9: uf-debian-9
	docker build ${DOCKER_BUILD_FLAGS} \
		-f py23-image/debian-9/Dockerfile \
		--build-arg KHULNASOFT_PRODUCT=uf \
...
sample-compose-up: sample-compose-down
	docker-compose -f test_scenarios/${KHULNASOFT_COMPOSE} up -d 

sample-compose-down:
	docker-compose -f test_scenarios/${KHULNASOFT_COMPOSE} down --volumes --remove-orphans || true
...
test_centos7: clean ansible khulnasoft-centos-7 uf-centos-7 test_setup run_small_tests_centos7 run_large_tests_centos7

test_redhat8: clean ansible khulnasoft-redhat-8 uf-redhat-8 test_setup run_small_tests_redhat8 run_large_tests_redhat8

test_debian9: clean ansible khulnasoft-debian-9 uf-debian-9 test_setup run_small_tests_debian9 run_large_tests_debian9

test_debian10: clean ansible khulnasoft-debian-10 uf-debian-10 test_setup run_small_tests_debian10 run_large_tests_debian10

run_small_tests_centos7:
	@echo 'Running the super awesome small tests; CentOS 7'
	pytest -n 2 --reruns 1 -sv tests/test_single_khulnasoft_image.py --platform centos-7 --junitxml test-results/centos7-result/testresults_small_centos7.xml

run_large_tests_centos7:
	@echo 'Running the super awesome large tests; CentOS 7'
	pytest -n 2 --reruns 1 -sv tests/test_distributed_khulnasoft_image.py --platform centos-7 --junitxml test-results/centos7-result/testresults_large_centos7.xml

run_small_tests_redhat8:
	@echo 'Running the super awesome small tests; RedHat 8'
	pytest -n 2 --reruns 1 -sv tests/test_single_khulnasoft_image.py --platform redhat-8 --junitxml test-results/redhat8-result/testresults_small_redhat8.xml

run_large_tests_redhat8:
	@echo 'Running the super awesome large tests; RedHat 8'
	pytest -n 2 --reruns 1 -sv tests/test_distributed_khulnasoft_image.py --platform redhat-8 --junitxml test-results/redhat8-result/testresults_large_redhat8.xml
...
run_small_tests_debian9:
	...
	pytest -n 2 --reruns 1 -sv tests/test_single_khulnasoft_image.py --platform debian-9 --junitxml test-results/debian9-result/testresults_small_debian9.xml

run_large_tests_debian9:
	@echo 'Running the super awesome large tests; Debian 9'
	pytest -n 2 --reruns 1 -sv tests/test_distributed_khulnasoft_image.py --platform debian-9 --junitxml test-results/debian9-result/testresults_large_debian9.xml

run_small_tests_debian10:
	@echo 'Running the super awesome small tests; Debian 10'
	pytest -n 2 --reruns 1 -sv tests/test_single_khulnasoft_image.py --platform debian-10 --junitxml test-results/debian10-result/testresults_small_debian10.xml

run_large_tests_debian10:
	@echo 'Running the super awesome large tests; Debian 10'
	pytest -n 2 --reruns 1 -sv tests/test_distributed_khulnasoft_image.py --platform debian-10 --junitxml test-results/debian10-result/testresults_large_debian10.xml
...
test_python3_all: test_khulnasoft_python3_all test_uf_python3_all

test_khulnasoft_python3_all: test_khulnasoft_centos7_python3 test_khulnasoft_redhat8_python3 test_khulnasoft_debian9_python3 test_khulnasoft_debian10_python3

test_uf_python3_all: test_uf_centos7_python3 test_uf_redhat8_python3 test_uf_debian9_python3 test_uf_debian10_python3

test_khulnasoft_centos7_python3:
	$(call test_python3_installation,khulnasoft-py23-centos-7)

test_khulnasoft_redhat8_python3:
	$(call test_python3_installation,khulnasoft-py23-redhat-8)

test_khulnasoft_debian9_python3:
	$(call test_python3_installation,khulnasoft-py23-debian-9)

test_khulnasoft_debian10_python3:
	$(call test_python3_installation,khulnasoft-py23-debian-10)
...
test_python2_all: test_khulnasoft_python2_all test_uf_python2_all

test_khulnasoft_python2_all: test_khulnasoft_centos7_python2 test_khulnasoft_redhat8_python2 test_khulnasoft_debian9_python2 test_khulnasoft_debian10_python2

test_uf_python2_all: test_uf_centos7_python2 test_uf_redhat8_python2 test_uf_debian9_python2 test_uf_debian10_python2

test_khulnasoft_centos7_python2:
	$(call test_python2_installation,khulnasoft-py23-centos-7)

test_khulnasoft_redhat8_python2:
	$(call test_python2_installation,khulnasoft-py23-redhat-8)

test_khulnasoft_debian9_python2:
	$(call test_python2_installation,khulnasoft-py23-debian-9)

test_khulnasoft_debian10_python2:
	$(call test_python2_installation,khulnasoft-py23-debian-10)
...
test_debian10_image_size:
	$(call test_image_size,khulnasoft-debian-10)

define test_image_size
docker pull khulnasoft/khulnasoft:edge
CUR_SIZE=$$(docker image inspect $1:latest --format='{{.Size}}') ; \
EDGE_SIZE=$$(docker image inspect khulnasoft/khulnasoft:edge --format='{{.Size}}') ; \
...
clean_ansible:
	rm -rf khulnasoft-ansible

dev_loop:
	KHULNASOFT_IMAGE="khulnasoft-debian-10:latest" make sample-compose-down && sleep 15  &&  DOCKER_BUILD_FLAGS="--no-cache" make all && sleep 15 && KHULNASOFT_IMAGE="khulnasoft-debian-10:latest" make sample-compose-up
